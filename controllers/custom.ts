import {ThorIO,ControllerProperties,CanInvoke,CanSet} from 'thor-io.vnext'
@ControllerProperties("neoBroker",false,2000)
export class ExtendedBrokerontroller extends ThorIO.Controllers.BrokerController {
